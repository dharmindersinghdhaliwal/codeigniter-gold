...
<div class="single-channel-page" id="content-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div class="image-view" id="imageViewVideoThumbnail"></div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input type="text" placeholder="Video Title" id="title" name="title" class="form-control" required="required" />
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<label for="description">About</label>
								<textarea rows="7" id="description" name="description" class="form-control" placeholder="Description"></textarea>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
				...
				<div class="osahan-area mt-3">
					<button class="btn btn-outline-primary" name="save">Upload</button>
				</div>
			</div>
	...
	/**get file Duration and add into hideen field***/
		...
		$('#video').bind('change', function() {
			...
			// Check if file size exceede than 2 GB  (2000 MB)
			if(this.files[0].size/1024/1024>2000){
				$('.message').html('<div class="alert alert-danger"><p>The file exceeds the upload max filesize.</p><p>You can upload file size upto 2GB.</p></div>');
				$(this).val('');
	        	return false;
			}
		...
		$('form#form_upload').submit(function(){
			...
			$.ajax({
				...
				url: '<?= BASE_URL ?>upload/upload_save',
				type: 'POST',
				data: formData,
				cache: false,
				contentType: false,
