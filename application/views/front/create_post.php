<div class="single-channel-page" id="content-wrapper">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					...
					<textarea id="content" name="content" rows="5" placeholder="Write what in your mind.." class="form-control texteditor"></textarea>
				</div>
				<div class="form-group">
					<div class="row">
						<div class="col-sm-6">
							...
							<select class="form-control" name="privacy" id="privacy">
								...
								<option value="group">For Group</option>
							</select>
						</div>
						<div class="col-sm-6" id="userGroups" style="display: none;">
	...
	<script>
		$(document).ready(function() {
			...
			$('form#form_create_post').submit(function(){
				var content = tinymce.get("content").getContent();

				$("#content").val(content);
				var form_create_post = $('#form_create_post');
